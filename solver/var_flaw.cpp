...
var_flaw::var_flaw(solver &slv, resolver *const cause, var_item &v_itm) : flaw(slv, get_cause(cause), true), v_itm(v_itm) {}
var_flaw::~var_flaw() {}
...
void var_flaw::compute_resolvers()
{
    ...
    for (const auto &v : vals)
        add_resolver(*new choose_value(slv, smt::rational(1, static_cast<smt::I>(vals.size())), *this, *v));
}
